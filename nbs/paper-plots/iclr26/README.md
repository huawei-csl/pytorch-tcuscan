# Benchmarks and plots for ICLR 26 submission
...
### fig_6_6_spmv_new_only_32T
- To prepare csv files: `cd nbs/paper-plots/alenex26/fig_6_6_spmv_new_only_32T` and run `./run_all_benchmarks.sh`
- Run the notebook to make the plot.
