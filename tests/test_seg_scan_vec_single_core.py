...
def _test_tcuscan_seg_scan_vec_single_core(n: int, s: int, segm_density: float):
...
def test_tcuscan_seg_scan_vec_single_score_s_32_density_0_01(multiplier: int):
    s = 32
    segm_density = 0.01
    n = multiplier * s * s

    _test_tcuscan_seg_scan_vec_single_core(n, s, segm_density)


@pytest.mark.parametrize("multiplier", _MULTIPLIER[:-3])
def test_tcuscan_segscan_vec_single_score_s_64_density_0_01(multiplier: int):
    s = 64
    segm_density = 0.01
    n = multiplier * s * s
...
def test_tcuscan_segscan_vec_single_score_s_128_density_0_01(multiplier: int):
    s = 128
    segm_density = 0.01
    n = multiplier * s * s
...
@pytest.mark.parametrize("multiplier", _MULTIPLIER)
def test_tcuscan_segscan_vec_single_score_s_32_density_0_05(multiplier: int):
    s = 32
    segm_density = 0.05
    n = multiplier * s * s
...
@pytest.mark.parametrize("multiplier", _MULTIPLIER[:-3])
def test_tcuscan_segscan_vec_single_score_s_64_density_0_05(multiplier: int):
    s = 64
    segm_density = 0.05
    n = multiplier * s * s
...
@pytest.mark.parametrize("multiplier", _MULTIPLIER[:-6])
def test_tcuscan_segscan_vec_single_score_s_128_density_0_05(multiplier: int):
    s = 128
    segm_density = 0.05
    n = multiplier * s * s
