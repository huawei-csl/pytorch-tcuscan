...
extern "C" __global__ __aicore__ void csr_gather_fp16(
  ...
  tcuscan::run_csr_gather<half, false>(values_in, cols_in, rows_in, x_in, z_out,
                                       t.num_elems, t.num_row_ptr,
                                       t.num_x_elems, t.tile_len);
}
...
extern "C" __global__ __aicore__ void csr_gather_int16(
  ...
  tcuscan::run_csr_gather<int16_t, false>(values_in, cols_in, rows_in, x_in,
                                          z_out, t.num_elems, t.num_row_ptr,
                                          t.num_x_elems, t.tile_len);
}
...
extern "C" __global__ __aicore__ void csr_gather_fp32(
  ...
  tcuscan::run_csr_gather<float, false>(values_in, cols_in, rows_in, x_in,
                                        z_out, t.num_elems, t.num_row_ptr,
                                        t.num_x_elems, t.tile_len);
}
