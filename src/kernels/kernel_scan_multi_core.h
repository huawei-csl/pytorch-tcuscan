...
class KernelReduceTiles {
 ...
 public:
  ...
  __aicore__ inline void Init(GM_ADDR input, GM_ADDR output) {
    ...
    pipe.InitBuffer(vec_tile_input_q_, 1, tile_size_ * sizeof(InputT));
    ...
    pipe.InitBuffer(res_q_, 1, MIN_VEC_SIZE * sizeof(AccT));
  }
 ...
 private:
  ...
  TQue<QuePosition::VECIN, 1> vec_tile_input_q_;
  ...
  TQue<QuePosition::VECOUT, 1> res_q_;
...
class KernelCompleteRows {
 ...
 public:
  ...
  __aicore__ inline void Init(GM_ADDR input_rows, GM_ADDR sums,
    ...
    pipe.InitBuffer(vec_tile_q_, 1, tile_size_ * sizeof(T));
    pipe.InitBuffer(vec_tile_out_q_, 1, tile_size_ * sizeof(T));
 ...
 private:
  ...
  TQue<QuePosition::VECIN, 1> vec_tile_q_;
  TQue<QuePosition::VECOUT, 1> vec_tile_out_q_;
