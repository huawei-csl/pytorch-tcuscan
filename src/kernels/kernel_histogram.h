...
class KernelHistogram {
 ...
 public:
   ...
   * @param [in] x_min Smallest value of histogram bins.
   * @param [in] x_max Largest value of histogram bins.
   */
  __aicore__ inline KernelHistogram(uint32_t vec_len, uint32_t tile_len,
                                    int16_t num_bins, InputT x_min,
                                    InputT x_max)
...
__aicore__ inline void run_histogram(GM_ADDR vec_in, GM_ADDR vec_out,
                                     ...
                                     uint32_t num_bins, T x_min, T x_max) {
  if ASCEND_IS_AIV {
    KernelHistogram<T> op(vec_len, tile_len, num_bins, x_min, x_max);
