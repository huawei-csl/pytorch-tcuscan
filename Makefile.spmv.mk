...
profile_fp16_spmv_real_multi_cube_for_alenex26: # Suite-Sparse matrix ids: [2225, 2602, 2444, 1227, 541, 1867, 1238, 1399, 1357, 1385, 845, 566, 1589, 850, 807] + ...
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/vsp_bcsstk30_500sep_10in_1Kout/vsp_bcsstk30_500sep_10in_1Kout
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/kron_g500-logn16/kron_g500-logn16
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/enron/enron
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/water_tank/water_tank
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/mip1/mip1
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/gupta2/gupta2
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/bcircuit/bcircuit
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/TSOPF_FS_b300_c2/TSOPF_FS_b300_c2
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/nasasrb/nasasrb
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/qa8fm/qa8fm
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/g7jac200/g7jac200
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/pct20stif/pct20stif
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/c-67b/c-67b
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/H2O/H2O
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/Ga3As3H12/Ga3As3H12
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/me2010/me2010
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/k1_san/k1_san
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/crankseg_2/crankseg_2
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/laminar_duct3D/laminar_duct3D
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/pdb1HYS/pdb1HYS
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/pkustk04/pkustk04
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/crankseg_1/crankseg_1
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/struct3/struct3
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/c-70/c-70
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/Chebyshev4/Chebyshev4
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/GaAsH6/GaAsH6
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/srb1/srb1
	python3 ${PROFILING_SCRIPTS_PATH}/profile_sparse_matrices.py --bench spmv_multi_cube --s 128 --dtype fp16 --matrixpath /scratch/asobczyk/datasets/suite-sparse-alenex26/cant/cant
